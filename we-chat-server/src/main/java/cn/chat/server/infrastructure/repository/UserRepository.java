package cn.chat.server.infrastructure.repository;

import cn.chat.server.domain.user.model.*;
import cn.chat.server.domain.user.repository.IUserRepository;
import cn.chat.server.infrastructure.dao.*;
import cn.chat.server.infrastructure.po.*;
...
import static cn.chat.server.infrastructure.common.Constants.TalkType.Friend;
import static cn.chat.server.infrastructure.common.Constants.TalkType.Group;
